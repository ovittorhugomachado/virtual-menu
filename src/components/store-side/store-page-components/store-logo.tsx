...
export const Logo = () => {
    ...
    return (
        <div className="w-24 h-24 rounded-full relative min-w-[85px] min-h-[85px] max-w-[85px] max-h-[85px]">
            {isLoading ? (
            ...
            <button
                ...
                className="w-8 h-8 sm:w-8 sm:h-8 rounded-full bg-gray-400 text-black border-1 absolute bottom-0 left-0 flex items-center justify-center cursor-pointer"
